...
\begin{lemma}\label{groebner_basis_remainder_zero_iff_mem_span}
  \lean{MonomialOrder.groebner_basis_remainder_zero_iff_mem_span}
  \uses{IsGroebnerBasis}
...
\uses{S Polynomial, groebner_basis_remainder_zero_iff_mem_span}
...
\begin{lemma}\label{leading_term_ideal_span_monomial}
  \lean{Ideal.leading_term_ideal_span_monomial}
  \uses{leadingTerm, MonomialOrder}
  \[
...
\begin{lemma}\label{remainder_mem_ideal_iff}
  \lean{Ideal.remainder_mem_ideal_iff}
...
\begin{lemma}\label{rem_sub_rem_mem_ideal}
  \lean{Ideal.rem_sub_rem_mem_ideal}
  \uses{IsRemainder, IsGroebnerBasis}
  Let \( I \subseteq k[x_i : i \in \sigma] \) be an ideal, and let \( G \subseteq I \) be a finite subset.
