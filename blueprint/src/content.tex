...
\begin{definition}\label{leading_term_ideal}
  \lean{MonomialOrder.leading_term_ideal}
  \leanok
  \uses{leadingTerm}
...
\begin{lemma}\label{leadingTerm_ideal_span_monomial'}
  \lean{MonomialOrder.leadingTerm_ideal_span_monomial'}
  \leanok
  \uses{leadingTerm_ideal_span_monomial},
...
\begin{lemma}\label{monomial_not_mem_leading_term_ideal}
  \lean{MonomialOrder.monomial_not_mem_leading_term_ideal}

  \uses{leading_term_ideal}

\end{lemma}

\begin{lemma}\label{term_not_mem_leading_term_ideal}
  \lean{MonomialOrder.term_not_mem_leading_term_ideal}
...
\begin{lemma}\label{not_mem_leading_term_ideal}
  \lean{MonomialOrder.not_mem_leading_term_ideal}
